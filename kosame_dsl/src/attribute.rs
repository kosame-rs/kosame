...
use crate::{
    driver::Driver, keyword, parse_option::ParseOption, proc_macro_error::emit_call_site_error,
    schema::Table,
};
...
//                 $(
//                     let $field = define_attribute!(@initialize $ty);
//                 )*
//
//                 for attr in attrs {
...
//                             match item {
//                                 $(
//                                     define_attribute!(@branch $field: $ty),
//                                 )*
//                                 _ => {
//                                     return Err(syn::Error::new(attr.span(), "unexpected attribute meta"))
//                                 }
//                             }
//                         }
//                     } else {
...
//     };
//
//     (@initialize Vec<$ty:ty>) => { vec![] };
//     (@initialize $ty:ty) => { None };
//
//     (@branch $field:ident: Option<$ty:ty>) => { define_attribute!(@branch $field: $ty) };
//     (@branch $field:ident: Vec<$ty:ty>) => { define_attribute!(@branch $field: $ty) };
//     (@branch $field:ident: MetaRename) => { MetaItem::Rename(inner) => $field = inner };
//
